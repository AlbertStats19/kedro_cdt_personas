"""
data-bbog-integration-fabrica-personas file for ensuring the package is executable
as `data-bbog-integration-fabrica-personas` and
`python -m data_bbog_integration_fabrica_personas`
"""
